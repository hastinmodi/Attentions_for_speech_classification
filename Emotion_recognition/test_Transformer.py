...
def transformer(time_steps, num_layers, units, d_model, num_heads, dropout, output_size, projection, name="transformer"):
  ...
  if(time_steps*d_model!=5652): # Since 5 sec audio is taken
      paddings = tf.constant([[0, 0], [int((5652-time_steps*d_model)/2), int((5652-time_steps*d_model)/2)]])
...
checkpoint_path = './emotion_recognition/saved_models_5_sec/18102020-151728' 
